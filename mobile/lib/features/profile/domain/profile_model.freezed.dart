...
class _$AddressModelImpl implements _AddressModel {
  ...
  @override
  String toString() {
    return 'AddressModel(id: $id, label: $label, fullName: $fullName, phone: $phone, street: $street, city: $city, state: $state, postalCode: $postalCode, country: $country, isDefault: $isDefault)';
  }
...
abstract class _AddressModel implements AddressModel {
  const factory _AddressModel(
      ...
      final bool isDefault}) = _$AddressModelImpl;
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  const _$UpdateProfileRequestImpl({this.displayName, this.avatarUrl});
